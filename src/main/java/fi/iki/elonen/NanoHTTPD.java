...
public abstract class NanoHTTPD {
            ...
            public void run() {
                do {
                    try {
                        ...
                        asyncRunner.exec(new ActorContainedRunnable() {
                            @Override
                            public void run(ActorRef actor) {
                                OutputStream outputStream = null;
                                try {
                                    outputStream = finalAccept.getOutputStream();
                                    TempFileManager tempFileManager = tempFileManagerFactory.create();
                                    HTTPSession session = new HTTPSession(actor, tempFileManager, inputStream, outputStream, finalAccept.getInetAddress());
     ...
     * Pluggable strategy for asynchronously executing requests.
     *
     * Enhanced for OpenHIM Mediator Akka actors.
     */
    public abstract class ActorContainedRunnable implements Runnable {
        public abstract void run(ActorRef actor);
    ...
    public interface AsyncRunner {
        void exec(ActorContainedRunnable code);
    }
    ...
    protected class HTTPSession implements IHTTPSession {
        ...
        public HTTPSession(ActorRef requestActor, TempFileManager tempFileManager, InputStream inputStream, OutputStream outputStream) {
        ...
        public HTTPSession(ActorRef requestActor, TempFileManager tempFileManager, InputStream inputStream, OutputStream outputStream, InetAddress inetAddress) {
            this.requestActor = requestActor;
            this.tempFileManager = tempFileManager;
            this.inputStream = new PushbackInputStream(inputStream, BUFSIZE);
            this.outputStream = outputStream;
